...
class ThreePartUI:
    def __init__(self):
        ...
        self.default_font = self.get_font(16)
        self.title_font = self.get_font(26, bold=True)
        self.panel_title_font = self.get_font(18, bold=True)
        self.big_font = self.get_font(22, bold=True)
    ...
    def build_ui(self):
        ...
        main.pack(fill="both", expand=True, padx=26, pady=10)
    ...
    def build_left_panel(self):
        ...
        self.video_label.pack(padx=14, pady=8, fill="both", expand=True)
        ...
        self.sign_label.pack(pady=(5, 14))
    ...
    def build_middle_panel(self):
        ...
        self.chat_box.pack(padx=14, pady=8, fill="both", expand=True)
    ...
    def build_right_panel(self):
        ...
        self.status_frame.pack(fill="both", expand=True, padx=18, pady=10)
        ...
        if self.cap is not None:
            try:
                ...
                if ret and frame is not None:
                    frame = cv2.resize(frame, (285, 210))
