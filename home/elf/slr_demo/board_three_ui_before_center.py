...
class BoardUI:
    ...
    def build_ui(self):
        # 彻底去掉顶部总标题，三栏直接铺满屏幕
        self.left = self.make_panel(4, 4, 500, 472, "左区：摄像头画面")
        self.middle = self.make_panel(508, 4, 180, 472, "中区：对话")
        self.right = self.make_panel(692, 4, 104, 472, "右区：状态")
        ...
        self.video_label.place(x=8, y=32, width=484, height=350)
        ...
        self.sign_label.place(x=8, y=390, width=484, height=70)
        ...
        self.chat_box.place(x=6, y=32, width=168, height=428)
    ...
    def add_status_row(self, key, value, y):
        ...
        key_label.place(x=4, y=y, width=96, height=18)
        ...
        value_label.place(x=4, y=y + 20, width=96, height=40)
